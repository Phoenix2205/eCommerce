...
public class SearchActivityAdapter extends RecyclerView.Adapter {
    ...
    Context context;
    public SearchActivityAdapter(Context context, List<Product> data ) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.recycler_view_search_cell,parent,false);
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            productPhoto=(ImageView)itemView.findViewById(R.id.image_view_product_search_cell);
            //   categoryName=(TextView) itemView.findViewById(R.id.);
            productName=(TextView)itemView.findViewById(R.id.text_view_product_name_search_cell);
            price=(TextView)itemView.findViewById(R.id.text_view_price_search_cell);
            add=(Button)itemView.findViewById(R.id.button_add_search_cell);
